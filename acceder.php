...
header('location: http://localhost/salir');
}
  ...
  <div style="float:right;width:335px;">
    <div style="padding:3px;margin:5px 0;border:1px solid #c3d9ff;">
      <div style="background-color:#e8eefa;padding:8px;">
        <div style="text-align:center;"><img src="http://localhost/img/logo.png" width="110" height="40"></div>
        <div style="text-align:center;padding:5px 0;margin:0 0 5px;">Log In to your <b>SuTubo</b> account</div>
        <form name="frmUser" method="post">
          ...
          <div style="width:300px;">
            <div style="float:left;width:100px;">
              <div style="text-align:right;padding:2px 0;margin:2px;">Username:</div>
              <div style="text-align:right;padding:2px 0;margin:2px;">Password:</div>
            </div>
            <div style="float:right;width:200px;">
              ...
              <div style="padding:5px 0;margin:5px 0;"><a style="font-size:11px;" href="http://localhost/contact.php">Can't access to your account?</a></div>
            </div>
